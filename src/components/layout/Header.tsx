                ...
                <div className='w-full flex justify-between items-center py-3 sm:py-4 bg-white/80 shadow-sm border-b border-gray-100 backdrop-blur-sm'>
                    <div className='flex justify-between items-center container mx-auto px-8'>
                        ...
                        <Link href='#' className='absolute left-1/2 -translate-x-1/2'>
                            <span className='text-xl sm:text-2xl font-bold tracking-tight'>Utrabeauty</span>
                        </Link>

                        <div className='flex flex-1 justify-end items-center gap-2 sm:gap-4'>
                            {/* Simple Search Bar */}
                            <div className='flex items-center bg-white border border-gray-300 rounded-lg px-3 py-2 mr-4'>
                                <input
                                    type='text'
                                    placeholder='Search products...'
                                    className='w-64 px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent'
                                />
